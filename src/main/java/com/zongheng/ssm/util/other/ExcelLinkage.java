...
public class ExcelLinkage {
    ...
    private List<String> province = new ArrayList<String>(Arrays.asList("湖南","广东"));

    private List<String> hnCity = new ArrayList<String>(Arrays.asList("长沙市","邵阳市"));

    private List<String> gdCity = new ArrayList<String>(Arrays.asList("深圳市","广州市"));
    ...
    public static void main(String[] args) {
        ...
        linkage.Export();
        System.out.println("已生成excel，请查看");
    }
