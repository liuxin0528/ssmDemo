package com.zongheng.ssm.mapping;

import java.util.Date;

public class TdMStaff {
    ...
    public void setDimissionTag(String dimissionTag) {
        this.dimissionTag = dimissionTag == null ? null : dimissionTag.trim();
    }
    ...
    public void setCustManagerFlag(String custManagerFlag) {
        this.custManagerFlag = custManagerFlag == null ? null : custManagerFlag.trim();
    }
    ...
    public String getEmerLinkMan() {
        return emerLinkMan;
    }

    public void setEmerLinkMan(String emerLinkMan) {
        this.emerLinkMan = emerLinkMan == null ? null : emerLinkMan.trim();
    }
    ...
    public void setEmerRel(String emerRel) {
        this.emerRel = emerRel == null ? null : emerRel.trim();
    }
